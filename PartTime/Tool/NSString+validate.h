...
/** 判断输入内容是否为中文(包括空格) */
+ (BOOL)validataInputIsChineseAndBlank:(NSString *)string;
/** 判断输入内容是否为中文(不包括空格) */
+ (BOOL)validataInputOnlyIsChinese:(NSString *)string;

/** 判断输入内容是邮编 */
+ (BOOL)validataInputPostNum:(NSString *)string;
